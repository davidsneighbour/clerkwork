---
id: clerkwork-resume-interrupted-work
name: clerkwork-resume-interrupted-work
...
> Before starting repository work, agents must check for project-root `RESUME.md`. If it exists, they must read it, resolve or explicitly abandon the unfinished work, and remove `RESUME.md` before starting unrelated work. When available, follow `skills/20-repository-workflows/clerkwork-resume-interrupted-work/SKILL.md` for the full protocol.
