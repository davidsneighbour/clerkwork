---
id: clerkwork-work-through-issues
name: clerkwork-work-through-issues
title: Work through GitHub Issues
type: skill
description: Continuously work through open GitHub issues until no suitable actionable issues remain, committing each fix individually. Orchestrates clerkwork-select-next-issue and clerkwork-work-on-issue in a loop.
---
...
```text
~/.ai/skills/20-repository-workflows/clerkwork-select-next-issue/SKILL.md
```

and:

```text
~/.ai/skills/20-repository-workflows/clerkwork-work-on-issue/SKILL.md
```
...
```text
~/.ai/skills/20-repository-workflows/clerkwork-work-on-next-issue/SKILL.md
~/.ai/skills/20-repository-workflows/clerkwork-work-on-issue/SKILL.md
```
...
1. Run `~/.ai/skills/20-repository-workflows/clerkwork-select-next-issue/SKILL.md`.
2. If no issue is selected, stop.
3. Extract the selected issue number.
4. Run `~/.ai/skills/20-repository-workflows/clerkwork-work-on-issue/SKILL.md` with that issue number.
...
6. Pass the selected issue number as the required input.
   ...
   ```text
   Work on issue #123 using ~/.ai/skills/20-repository-workflows/clerkwork-work-on-issue/SKILL.md.
   ```
